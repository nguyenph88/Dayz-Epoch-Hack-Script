...
img = img + [""]; option = option + ["This project is hosted on github as my public repo, keep it up to date at:","empty.sqf","0","0","0"];
...
img = img + [""]; option = option + ["Most of the scripts will not be logged from server, I will try to minimize the chance of being caught.","empty.sqf","0","0","0"];
